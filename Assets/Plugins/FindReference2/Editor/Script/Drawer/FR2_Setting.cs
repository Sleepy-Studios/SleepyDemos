...
namespace vietlabs.fr2
{
    ...
    internal class FR2_Setting
    {
        ...
        public bool badgeReferenceCount = false;
        ...
        */
        ...
        public static bool BadgeReferenceCount
        {
            get => s.badgeReferenceCount;
            set
            {
                if (s.badgeReferenceCount == value) return;

                s.badgeReferenceCount = value;
                FR2_Cache.MarkDirty();
                EditorApplication.RepaintProjectWindow();
            }
        }
