...
namespace vietlabs.fr2
{
    internal partial class FR2_WindowAll
    {
        ...
        private void OnSelectionManagerChanged()
        {
            ...
            FR2_LOG.Log($"{nameof(FR2_WindowAll)}::{nameof(OnSelectionManagerChanged)}");
        ...
        void OnPanelSelectionChanged()
        {
            ...
            FR2_LOG.Log($"{nameof(FR2_WindowAll)}::{nameof(OnPanelSelectionChanged)}");
        ...
        {
            FR2_LOG.Log($"{nameof(FR2_WindowAll)}::{nameof(RefreshFR2View)}");
