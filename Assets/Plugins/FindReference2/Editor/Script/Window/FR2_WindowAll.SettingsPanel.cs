        ...
        private void DrawMainSettings()
        {
            using (HzLayout())
            {
                ...
                using (VtLayout(GUILayout.Width(200f)))
                {
                    ...
                    bool dbValidation = FR2_SettingExt.dbValidation;
                    FR2_GUI.DrawToggleLeft("DB Validation", ref dbValidation);
                ...
                using (VtLayout(GUILayout.Width(200f)))
                {
                    ...
                    using (GUIEnable(FR2_Setting.s.referenceCount))
                    {
                        bool badgeReferenceCount = FR2_Setting.s.badgeReferenceCount;
                        FR2_GUI.DrawToggleLeft("Badge Style Count", ref badgeReferenceCount);
                        if (badgeReferenceCount != FR2_Setting.s.badgeReferenceCount)
                            FR2_Setting.s.badgeReferenceCount = badgeReferenceCount;
                    }
                }
            }
