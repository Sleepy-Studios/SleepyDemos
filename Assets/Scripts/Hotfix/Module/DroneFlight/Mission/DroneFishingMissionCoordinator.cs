...
namespace Hotfix.DroneFlight
{
    ...
    public sealed class DroneFishingMissionCoordinator : MonoBehaviour
    {
        ...
        [SerializeField] private Vector2 fishAreaHalfExtents = new(3f, 3f);
        [SerializeField] private float fishDepthMeters = -5f;
        [SerializeField, Range(1, 2)] private int orbitLoops = 2;
        [SerializeField, Min(0.1f)] private float routeSpeedMetersPerSecond = 4f;
        [SerializeField, Min(0.1f)] private float returnSpeedMetersPerSecond = 3f;
        [SerializeField, Min(0.5f)] private float maximumTrackingErrorMeters = 2.5f;
        [SerializeField, Min(1f)] private float routePhaseTimeoutSeconds = 60f;
        [SerializeField, Min(1f)] private float firingTimeoutSeconds = 10f;
